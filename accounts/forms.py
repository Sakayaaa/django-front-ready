...
class UserProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'youtube': forms.URLInput(attrs={'placeholder': "Youtube URL (https://youtube.com/XXXXX)"}),
            'linkedin': forms.URLInput(attrs={'placeholder': "Linkedin URL (https://linkedin.com/XXXXX)"}),
            'instagram': forms.URLInput(attrs={'placeholder': "Instagram URL (https://instagram.com/XXXXX)"}),
